...
export default function QuickImpact() {
    const impacts = [
        ...
        },
        {
            icon: Target,
            metric: "9",
            title: "High-Quality Projects Delivered",
            description:
                "Consistently delivered projects on time with defect rate lower than 5%",
            details: [
    ...
    return (
        <div className="mb-16">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                {impacts.map((impact, index) => {
                    ...
                    return (
                        <div
                            key={index}
                            className={`group relative overflow-hidden ${impact.bgPattern} border-2 ${colors.border} rounded-3xl p-8 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2`}
                        >
                            {/* Background Pattern */}
                            <div className="absolute inset-0 opacity-5">
                                <div
                                    className={`absolute inset-0 ${impact.bgPattern} transform rotate-12 scale-150`}
                                ></div>
                            </div>
                            ...
                            <div className="relative">
                                ...
                                <div className="flex items-start justify-between mb-6">
                                    <div className="flex items-center gap-4">
                                        <div
                                            className={`w-16 h-16 bg-white dark:bg-gray-800 rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300`}
                                        >
                                            <Icon
                                        ...
                                        <div>
                                            <div
                                                className={`text-4xl lg:text-5xl font-bold ${colors.metric} mb-1 group-hover:scale-105 transition-transform`}
                                            >
                                                {impact.metric}
                                            </div>
                                    ...
                                    <ArrowUpRight className="w-6 h-6 text-gray-400 group-hover:text-gray-600 dark:group-hover:text-gray-300 transition-colors" />
                                </div>
                                ...
                                <div className="space-y-3">
                                    ...
                                    {impact.details.map((detail, idx) => (
                                        <div
                                            key={idx}
                                            className="flex items-start gap-3 group/detail"
                                        >
                                            <div
                                                className={`w-2 h-2 ${colors.dot} rounded-full mt-2 flex-shrink-0 group-hover/detail:scale-125 transition-transform`}
                                            ></div>
                                            <span className="text-sm text-gray-600 dark:text-gray-400 group-hover/detail:text-gray-700 dark:group-hover/detail:text-gray-300 transition-colors">
                                                {detail}
                                            </span>
                                        </div>
                                    ))}
            ...
            {/* Summary Stats */}
            <div className="mt-16 bg-gradient-to-r from-gray-50 to-blue-50 dark:from-gray-900 dark:to-blue-900/20 rounded-3xl p-8 border border-gray-200 dark:border-gray-700">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
                    <div className="text-center group">
                        <div className="w-16 h-16 bg-blue-100 dark:bg-blue-900/30 rounded-2xl flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform">
                    ...
                    <div className="text-center group">
                        <div className="w-16 h-16 bg-green-100 dark:bg-green-900/30 rounded-2xl flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform">
                    ...
                    <div className="text-center group">
                        <div className="w-16 h-16 bg-purple-100 dark:bg-purple-900/30 rounded-2xl flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform">
                    ...
                    <div className="text-center group">
                        <div className="w-16 h-16 bg-orange-100 dark:bg-orange-900/30 rounded-2xl flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform">
