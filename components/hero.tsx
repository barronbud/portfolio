...
export default function Hero() {
    return (
        <div className="relative">
            {/* Hero Section */}
            <div className="bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-gray-900 dark:via-blue-900/20 dark:to-indigo-900/20 rounded-3xl p-8 lg:p-12 mb-16 overflow-hidden">
                {/* Background Pattern */}
                ...
                <div className="relative flex flex-col lg:flex-row items-center lg:items-start gap-8 lg:gap-12">
                    ...
                    <div className="flex-shrink-0 relative">
                        <div className="relative">
                            <Image
                                ...
                                className="rounded-3xl shadow-2xl ring-4 ring-white/50 dark:ring-gray-800/50"
                                priority
                            />
                            {/* Status Indicator */}
                    ...
                    <div className="flex-1 text-center lg:text-left">
                        <div className="mb-6">
                            <h1 className="text-5xl lg:text-6xl font-bold tracking-tight text-gray-900 dark:text-white mb-4">
                                Jeffrey Barron
                            </h1>
                            <h2 className="text-2xl lg:text-3xl text-blue-600 dark:text-blue-400 font-semibold mb-6">
                        ...
                        <div className="mb-8">
                            <p className="text-xl lg:text-2xl text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
                                I transform engineering teams into high-velocity, collaborative powerhouses that deliver exceptional results.
                            </p>
                            <p className="text-lg text-gray-600 dark:text-gray-400 leading-relaxed">
                                With <span className="font-semibold text-blue-600 dark:text-blue-400">10+ years</span> in software development and <span className="font-semibold text-blue-600 dark:text-blue-400">3+ years</span> leading remote teams, I've consistently increased team velocity by <span className="font-semibold text-green-600 dark:text-green-400">150%</span> while building scalable solutions across fintech, edutech, and e-commerce.
                            </p>
                        </div>

                        {/* Key Metrics */}
                        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                            <div className="text-center p-4 bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm rounded-xl shadow-sm border border-white/20 dark:border-gray-700/20">
