import { TrendingUp, Clock, Users, Target, Zap, Award, CheckCircle, ArrowUpRight } from "lucide-react";
        ...
        <div className="mb-16">
            <div className="text-center mb-12">
                ...
                <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
                    Here&apos;s what happened when I applied these leadership approaches to actual engineering
                    challenges
                </p>
            </div>
                            ...
                            <div className="relative">
                                ...
                                <div className="flex items-start justify-between mb-6">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <div className={`text-4xl lg:text-5xl font-bold ${colors.icon} mb-1`}>
                                                {impact.metric}
                                            </div>
            ...
            <div className="bg-gradient-to-r from-gray-50 to-blue-50 dark:from-gray-900 dark:to-blue-900/20 rounded-3xl p-8 border border-gray-200 dark:border-gray-700">
                <div className="text-center mb-8">
                    <h4 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">The Bigger Picture</h4>
                    <p className="text-gray-600 dark:text-gray-400">
                        These results aren&apos;t one-offs—they represent consistent patterns across different teams and
                        challenges
                    </p>
                </div>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
                    <div className="text-center group">
                        ...
                        <div className="text-2xl font-bold text-gray-900 dark:text-white mb-1">&gt; 90%</div>
                    ...
                    <div className="text-center group">
                        ...
                        <div className="text-sm text-gray-600 dark:text-gray-400">Team Retention Rate</div>
                    </div>
                    ...
                    <div className="text-center group">
                        ...
                        <div className="text-sm text-gray-600 dark:text-gray-400">Years Leadership</div>
                    </div>
